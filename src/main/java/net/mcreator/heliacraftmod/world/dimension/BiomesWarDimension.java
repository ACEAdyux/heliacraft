...
package net.mcreator.heliacraftmod.world.dimension;
...
public class BiomesWarDimension extends HeliacraftModModElements.ModElement {
	public BiomesWarDimension(HeliacraftModModElements instance) {
		super(instance, 2);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("heliacraft_mod:biomes_war"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
